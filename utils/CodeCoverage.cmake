# Taken from https://github.com/pyarmak/cmake-gtest-coverage-example/blob/master/cmake/modules/CodeCoverage.cmake
#
...
FUNCTION(SETUP_TARGET_FOR_COVERAGE _targetname _testrunner _outputname)
    ...
    ADD_CUSTOM_TARGET(${_targetname}
            ...
            COMMAND ${LCOV_PATH} --rc lcov_branch_coverage=1 --remove ${_outputname}.info '*unittest*' 'build/*' 'tests/*' '/usr/*' --output-file ${_outputname}.info.cleaned
